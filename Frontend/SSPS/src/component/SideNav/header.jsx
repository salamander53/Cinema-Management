...
export default function PageHeader() {
  ...
  return (
    <StyledHeader>
      <Title>{locate.startsWith(`/printer`)?"Quản lý rạp phim":locate.startsWith(`/student`)?"Quản lý sinh viên":locate.startsWith(`/config`)?"Quản lý cấu hình":locate.startsWith(`/setting`)?"Cài đặt":locate.startsWith(`/help`)?"Hướng dẫn sử dụng":"Bảng điều kiển"}</Title>
      <UserInfo>
